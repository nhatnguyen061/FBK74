...
@WebServlet(name = "AddCourseController", urlPatterns = {"/admin/AddCourse"})
public class AddCourseController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       if (c != null) {
        ...
        request.getRequestDispatcher("AddCourse_thuy.jsp").forward(request, response);
    }
...
// Call the method to insert the course into the database
       ...
       int courseId = newId;
        ...
        String imagefieldName = file.getSubmittedFileName();
        String uploadPath = "D:/Java/FBK74/web/img_thuy" + imagefieldName;
        try {
      ...
      // Create YouthTrainingCourse object
        ...
        course.setImage(imagefieldName);
       ...
       course.setIdYouthTrainingCourse(courseId);
        ...
        try {
            ...
            dao.createYouthTrainingCourse(course);
        } catch (Exception e) {
