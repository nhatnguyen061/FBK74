 ...
 * @author ngoba
 */
@WebServlet(name = "CancelClass", urlPatterns = {"/admin/cancelclass"})
public class CancelClass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CancelClass</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CancelClass at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ClassEntity list = cDAO.getClassById(idClass);
        int idCourse = list.getIdYouthTrainingCourse();

        try {
            cDAO.cancelClass(idClass);
        } catch (Exception e) {
