                        ...
                        <div class="col-md-6">
                            <div class="form-container">
                                ...
                                <form action="product" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="action" value="update"> <!-- Hidden input for action parameter -->
                                    <input type="hidden" name="id" value="${oldProduct.id}"> <!-- Hidden input for action parameter -->
                                    <div class="form-group">
                                        <label for="name" class="form-label">Tên sản phẩm</label>
                                        <input value="${oldProduct.name}"type="text" id="name" name="name" class="form-control" placeholder="Nhập tên sản phẩm" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="${oldProduct.quantity}"type="number" id="quantity" name="quantity" class="form-control" placeholder="Nhập số lượng" required>
                                    </div>
                                    <div class="flex justify-center">
                                        <button type="submit" class="btn btn-add-product" style="background-color: green;">Cập nhật Sản phẩm</button>
                                    </div>                                </form>
                            </div>
                        </div>
                    </div>
