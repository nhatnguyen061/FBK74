    ...
    <head>
        ...
        <style>
            ...
            .team.award {
                ...
                position: relative;
                margin-top: 40px; /* Default margin for alignment */
            }
            ...
            .team.award.runner-up {
                background: linear-gradient(to right, #c9c9c9, #e6e6e6);
                box-shadow: 0 0 15px #c9c9c9;
                margin-top: 20px; /* Middle position */
                z-index: 2;
            }

            .team.award.third-place {
                background: linear-gradient(to right, #b08d57, #d9a678);
                box-shadow: 0 0 15px #b08d57;
                margin-top: 40px; /* Lowest position */
                z-index: 1;
            }
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="awards-container">
                        <div class="team award runner-up">
                            <h2>Á Quân</h2>
                            <p>Real Madrid</p>
                        </div>
                        <div class="team award winner">
                            <h2>Đội Vô Địch</h2>
                            <p>FC Barcelona</p>
                        </div>
                        <div class="team award third-place">
                            <h2>Về Thứ Ba</h2>
                            <p>Liverpool</p>
                        </div>
                    </div>
