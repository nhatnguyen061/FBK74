 ...
 * @author nhatk
 */
@WebServlet(name = "LichsuhoadonServlet_nhat", urlPatterns = {"/lichsuhoadon"})
public class LichsuhoadonServlet_nhat extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet LichsuhoadonServlet_nhat</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet LichsuhoadonServlet_nhat at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null) {
            ...
            //lưu lại các hóa đơn của khách hàng thanh toán
