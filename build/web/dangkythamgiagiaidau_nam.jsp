            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="tournament-title-container">
                        <h2 class="tournament-title animate__animated animate__pulse">Đăng Ký Tham Gia Giải Đấu</h2>
                    </div>

                    <div class="container mt-5">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="img/giaidau5.jpg" alt="Ảnh Giải đấu 1" class="img-fluid">
                            </div>
                            <div class="col-md-6">
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                            <th>Tên Giải Đấu</th>
                                            <td>
                                                <select name="tournamentName" class="form-control">
                                                    <option value="Giải đấu 1">Giải đấu 1</option>
                                                    <option value="Giải Đấu 2">Giải Đấu 2</option>
                                                    <option value="Giải đấu 3">Giải đấu 3</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
