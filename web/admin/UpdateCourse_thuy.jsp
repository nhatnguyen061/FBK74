    ...
    <body>
        <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <div class="content">
                ...
                <!-- Navbar End -->           
                <div class="container">
                    <h2 class="text-primary1 mb-4">Cập nhật khóa học</h2>
                    <jsp:include page="../common/Message.jsp" />
                    <form id="addCourseForm" action="UpdateCourse" method="post" onsubmit="return validateForm()"enctype="multipart/form-data">
                        <input type="text" class="form-control" id="courseId" name="id" value="${courseId}" hidden="">

                        <div class="mb-3">
                            <label for="name" class="form-label">ID Khóa học:</label>
                            <input type="text" class="form-control" id="courseId" name="courseId" value="${courseId}" disabled="">
                            <div class="invalid-feedback">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="name" class="form-label">Tên khóa học:</label>
                            <input type="text" class="form-control" id="name" name="name" value="${course.getNameYouthTrainingCourse()}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            <label for="description" class="form-label">Giới thiệu khóa học:</label>
                            <textarea class="form-control" id="description" name="description"  required>${course.getInformation()}</textarea>
                            <div class="invalid-feedback">
                                Vui lòng nhập"Giới thiệu khóa học"
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="startDate" class="form-label">Thời gian mở đăng ký:</label>
                            <input type="date" class="form-control" id="timeRegist" name="timeRegist" value="${course.getTimeRegist()}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="startDate" name="startDate" value="${course.getTimeStart()}" required>
                            <div class="invalid-feedback">
                                Vui lòng nhập ngày hợp lệ!
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="endDate" name="endDate" value="${course.getTimeCloseRegist()}" required>
                            <div class="invalid-feedback">
                                Vui lòng nhập ngày hợp lệ!
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="fee" name="tuition" value="${course.getTuition()}" required>
                            <div class="invalid-feedback">
                                Vui lòng nhập số hợp lệ!
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="fee1" class="form-label">Hình ảnh: </label>
                            <input type="file" class="form-control" id="fee1" name="img1"  required>
                            <div class="invalid-feedback">
...
function validateForm() {
    var timeRegist = new Date(document.getElementById('timeRegist').value);
    var startDate = new Date(document.getElementById('startDate').value);
    var endDate = new Date(document.getElementById('endDate').value);
    var currentDate = new Date();

    if (timeRegist <= currentDate) {
        alert('Thời gian mở đăng ký phải lớn hơn ngày hiện tại');
        return false;
    }

    if (endDate <= timeRegist) {
        alert('Ngày đóng đăng ký phải lớn hơn ngày mở đăng ký');
        return false;
    }

    if (startDate <= endDate) {
        alert('Ngày bắt đầu phải lớn hơn ngày đóng đăng ký');
        return false;
    }
