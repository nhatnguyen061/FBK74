         ...
         <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    <h2 class="text-primary1">Danh sách học sinh</h2>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <c:forEach var="course" items="${listMem}">
                                <tr>
                                    <td>${course.idMemberOfClass}</td>
                                    <td>${course.idClass}</td>
                                    <td>${course.phoneNumber}</td>
                                    <td>${course.nameStudent}</td>
                                    <td>${course.age}</td>
                                    <td>${course.height}</td>
                                    <td>${course.weight}</td>
                                    <td>
                                        <a href="approveSuccess?idMem=${course.idMemberOfClass}" onclick="return confirm('Bạn muốn phê duyệt thành viên này ?');">
                                            <button class="btn btn-success">Phê duyệt</button>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="approveCancel?idMem=${course.idMemberOfClass}" onclick="return confirm('Bạn có chắc chắn muốn hủy đơn này không?');">
