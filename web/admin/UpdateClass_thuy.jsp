    ...
    <body>
        <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <div class="content">
                ...
                <!-- Navbar End -->           
                <div class="container">
                    <h2 class="text-primary1 mb-4">Cập nhật lớp học</h2>
                    <jsp:include page="../common/Message.jsp" />

                    <form id="addCourseForm" action="updateclass?classId=${classId}" method="post" >
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="invalid-feedback">
                                Vui lòng nhập số điện thoại HLV.
                            </div>
                        </div>
                        <div class="mb-3">
