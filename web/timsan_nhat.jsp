                        ...
                        <div class="ml-auto">
                            <nav class="site-navigation position-relative text-right" role="navigation">
                                <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                                    ...
                                    <li class="active"><a href="danhsachtimsan" class="nav-link">Tìm Sân</a></li>
                                    <li>
                        ...
                        <form action="danhsachtimsan" method="get" class="mt-3 w-100" id="myForm">
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input style="background-color: #000; color: #fff;" type="text" value="${currentDate}" placeholder="${currentDate}" class="form-control" id="ngay" name="ngay" autocomplete="off" />
                                </div>
                                <div class="col-md-4">
                                    <label for="gio" class="labelform">Thời gian:</label>
                                    <select style="background-color: #000; color: #fff;" class="form-control" id="gio" name="gio">
