            ...
            <div class="row">
                    ...
                    <div class="booking-form p-4 shadow" data-aos="fade-right" data-aos-delay="100">
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="fieldName" value="${requestScope.ffs.footballField.name}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="fieldType" class="form-label">Loại Sân</label>
                                <input type="text" class="form-control" id="fieldType" value="Sân gồm ${requestScope.ffs.footballField.typeofFootballField} người/ Đội" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="startTime" class="form-label">Thời gian bắt đầu</label>
                                <input type="text" class="form-control" id="startTime" value="${requestScope.ffs.startTime}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="endTime" class="form-label">Thời gian kết thúc</label>
                                <input type="text" class="form-control" id="endTime" value="${requestScope.ffs.endTime}"readonly>
                            </div>
                            <div class="mb-3">
                                <label for="price" class="form-label">Giá tiền</label>
                                <input type="text" class="form-control" id="price" value="${requestScope.ffs.footballField.price} VNĐ" readonly>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-5">
                    <div class="booking-info p-4 shadow" data-aos="fade-left" data-aos-delay="100">
                        ...
                        <form action="datsan" method="get" id="bookingForm">                            
                            <div class="mb-3">
                                <label for="fieldBooked" class="form-label">Tên sân cần đặt</label>
                                <input type="text" class="form-control" id="fieldBooked" value="${requestScope.ffs.footballField.name}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="deposit" class="form-label">Giá tiền cọc</label>
                                <input type="text" class="form-control" id="deposit" value="100.000 VNĐ" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="bookingTime" class="form-label">Thời gian</label>
                                <input type="text" class="form-control" id="bookingTime" value="${sessionScope.ngay}" readonly>
                            </div>
                            <div class="mb-3">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                form.addEventListener("submit", function (event) {
                    var bookerNameInput = form.querySelector("#bookerName");
                    var bookerNameError = form.querySelector("#bookerNameError");

                    var phoneInput = form.querySelector("#phone");
                    var phoneError = form.querySelector("#phoneError");

                    // Validation cho trường bookerName
                    validateInput(bookerNameInput, bookerNameError, "Vui lòng nhập tên người đặt sân.", event);

                    // Validation cho trường phone
                    validatePhoneInput(phoneInput, phoneError, "Vui lòng nhập số điện thoại đúng định dạng (ví dụ: 1234567890).", event);
                });

                // Sự kiện input để loại bỏ thông báo lỗi và viền đỏ khi người dùng bắt đầu nhập liệu lại
                form.addEventListener("input", function (event) {
                    var input = event.target;
                    var errorId = input.id + "Error";
                    var error = form.querySelector("#" + errorId);

                    input.classList.remove("border-danger");
                    error.textContent = "";
                });

                // Hàm validation cho trường bookerName
                function validateInput(input, error, errorMessage, event) {
                ...
                // Hàm validation cho trường phone
                function validatePhoneInput(input, error, errorMessage, event) {
                    var inputValue = input.value.trim();
